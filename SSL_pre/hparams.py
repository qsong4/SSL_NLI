...
class Hparams:
    ...
    # train
    ## files
    parser.add_argument('--train', default=cur_dir + '/data/snli_train.tsv',
                             help="training data")
    parser.add_argument('--eval', default=cur_dir + '/data/snli_test.tsv',
                             help="evaluation data")
    parser.add_argument('--test_file', default=cur_dir + '/data/snli_test.tsv')

    parser.add_argument('--train_prepro', default=cur_dir + '/data/train_prepro',
                        help="processed training data")
    parser.add_argument('--dev_prepro', default=cur_dir + '/data/dev_prepro',
                        help="processed dev data")

    parser.add_argument('--model_path', default='SSLNLI_E%02dL%.3f')
    parser.add_argument('--modeldir', default=cur_dir + '/SSL_pre/model')
    parser.add_argument('--vec_path', default=cur_dir + '/data/vec/snli_trimmed_vec.npy')

    ## vocabulary
    parser.add_argument('--vocab', default=cur_dir + '/data/snli.vocab',
