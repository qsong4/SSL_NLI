...
class SSLNLI_lstm:
    def __init__(self, hp):
        ...
        self.x = tf.placeholder(tf.float32, [None, self.hp.maxlen, self.hp.d_model], name="text_x")
        self.y = tf.placeholder(tf.float32, [None, self.hp.maxlen, self.hp.d_model], name="text_y")
